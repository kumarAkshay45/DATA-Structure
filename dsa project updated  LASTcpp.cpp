      ...
      //adding a new customer
		...
		void display() {
			if (head == NULL) {
             ...
             //display all the customer name and there total         
...
int main() {
	...
	gotoxy(22,15);
	cout << "Khawar hussain   21I-2952" << endl;
	gotoxy(22,16);
	cout << "Akshay kumar     22K-4559" << endl;
	gotoxy(22,17);
	system("pause");
	system("cls");
...
//					system("pause");
			...
			default:
				cout << "\n\nYou entered an invalid choice, program ended\n\n";
